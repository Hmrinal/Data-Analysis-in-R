...
movie <- read.csv("E:/webD/ml/SVM/Files/Movie_classification.csv", header = TRUE)
...
df <- read.csv("E:/webD/ml/SVM/Files/Movie_regression.csv", header = TRUE)
...
## Importing relevant Library e1071 for svm
library (e1071)
